...
// themselves, committed and regenerated by `npm run thumbs` at the
// repository root — they cannot be made during the site's own build,
// which has no access to anything above this folder.
//
